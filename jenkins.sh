...
#Uncomment below line to skip setupwizard for jenkins
  exec java -Duser.home="$JENKINS_HOME" "${java_opts_array[@]}" -Djenkins.install.runSetupWizard=false -jar /usr/share/jenkins/jenkins.war "${jenkins_opts_array[@]}" "$@"
fi
